...
// //   if (req.body.density === "HIGH") {
// //     io.emit("alert", "🚨 Crowd limit exceeded!");
// //   }
...
// //   const stats = await CrowdStat.find();
...
// //         date,
// //         maxPeople: s.people,
// //         alerts: s.density === "HIGH" ? 1 : 0
// //       };
// //     } else {
// //       summary[date].maxPeople = Math.max(
// //         summary[date].maxPeople,
// //         s.people
// //       );
// //       if (s.density === "HIGH") summary[date].alerts++;
// //     }
// //   });
...
//   thresholds.low = Number(low);
//   thresholds.medium = Number(medium);
//   res.json(thresholds);
// });
...
//       };
//     } else {
//       summary[date].maxPeople = Math.max(summary[date].maxPeople, s.people);
//       if (s.density === "HIGH") summary[date].alerts++;
//     }
//   });
